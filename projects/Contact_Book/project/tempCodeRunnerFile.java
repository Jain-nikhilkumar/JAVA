...
//     JButton nn = new JButton("CONTACTC BOOK");
...
class Phone_B implements ActionListener {
    ...
    public void addWidgets() {
        ...
        button_Panel.add(AddNew);
        button_Panel.add(DeleteContact);
        button_Panel.add(SearchContacts);
        button_Panel.add(ViewContactList);

        bottom_Panel.add(button_Panel, BorderLayout.NORTH);
        bottom_Panel.add(new JLabel("Contact Book"), BorderLayout.CENTER);
